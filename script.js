...
const levelOne = `100001111111111111111111111
100000000000000000000000001
100000000000000000000000001
100000000000000000000000001
111111000111100011110000001
100000000000000000000000001
100000000000000000000000001
100000000000000000001000001
111100000000000000000000001
100100000000000000000000001
100110000000001000000000001
100000000000000000000000001
100000000000000000000000001
100001111000000000000000001
100000000000000000000000001
100000000000000000000000000
100000000000011111000000000
100000000000000000000000000
100000000000000000000000000
100000000000000000000011111
100000000000000000000010001
100000000000000000000010001
000000000000000000111110001
...
function input() {
  ...
  if (65 in keysDown) {
    ...
    if (getTile((player.x - player.speed) + 1, player.y + 16) === "0" && player.x > 1) {
  ...
  if (68 in keysDown) {
    // Check if tile at player location after move is colliding with a wall
    if (getTile(((player.x + player.width) + player.speed) - 1, player.y + 16) === "0" && player.x + player.width < canvas.width) {
...
var HKTitle = document.getElementById("knight-title");

function checkCharacterCollision() {
    if ((player.x > 29 && player.x <128) && (player.y > 157 && player.y < 256)) {
        HKTitle.style.opacity = "1";
    } else {
        HKTitle.style.opacity = "0";
    }
...
window.onload = function () {
  ...
  currentLevel = parseLevel(levelOne);
  // Start Platformer
  main();
}